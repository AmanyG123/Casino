...
int main()
{
    ...
    printf("Press 1 to play another game and 0 to quit\n");
    scanf("%d", &play);
   }
}
    ...
    for(c = 0; c < count; c++)
    {
        switch(type)
        {
            ...
            case FIVE:
                ...
                cash = cash + cashFiveDollar(fiveSO);
                } else {
                printf("You do not have enough cash\n");
                c = count;
                }
